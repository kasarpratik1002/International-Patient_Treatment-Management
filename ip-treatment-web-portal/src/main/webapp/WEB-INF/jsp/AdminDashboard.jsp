...
<h1 style="text-align: center;font-family:serif;"><b>WELCOME</b></h1>
</div>
<br>
<br>


<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 d-flex align-items-center card-align-center" >
<div class="col mb-3" >
	<a href="/specialist">
	<div class="card" >
		<div class="card-body">
		<img class="card-img-top"  src="/images/specialist.png">
        <div class="card-title"><h6><b>View Specialists</b></h6></div>
        </div>
	</div>
	</a>
	</div>
	...
	<div class="card" >
        ...
        <div class="card-title"><h6><b>View Treatments</b></h6></div>
        </div>
	</div>
	</a>
	</div>
	...
	<div class="card" >
        ...
        <div class="card-title"><h6><b>View Patients</b></h6></div>
        </div>
	</div>
	</a>
	</div>
	...
	<div class="card" >
        ...
        <div class="card-title"><h6><b>View Insurance Providers</b></h6></div>
        </div>
	</div>
	</a>
	</div>
	...
	<div class="card">
        ...
        <div class="card-title"><h6><b>Edit Treatment Plan</b></h6></div>
        </div>
	</div>
	</a>
	</div>
	...
	<div class="card" >
        ...
        <div class="card-title"><h6><b>View All Plans</b></h6></div>
        </div>
	</div>
	</a>
	</div>
